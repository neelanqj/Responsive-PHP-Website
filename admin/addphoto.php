	...
	<div id="center_form">
		<?php
            if ($_GET['action'] == 'add') {
                ...
                if ($image_name != "") {	
                    connectdb();
                    $query = "INSERT INTO mn_album (owner, title, album_name, picture, date, summary, price, status) VALUES ('".$_SESSION['name']."', '$album', 'photo', '$image_name', CURDATE(), '$description', '$price', '$status')";
            ...
            ?>
               ...
               <form action='addphoto.php?action=add&title=photo' 
               name='create_album' method='post' enctype="multipart/form-data">
                    <b>Photography Piece Name</b><br/>
